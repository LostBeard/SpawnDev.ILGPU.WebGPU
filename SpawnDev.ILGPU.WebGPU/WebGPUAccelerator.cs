...
namespace SpawnDev.ILGPU.WebGPU
{
    ...
    /// </summary>
    public sealed class WebGPUAccelerator : IDisposable
    {
        #region Static
        ...
        /// </summary>
        public static async Task<WebGPUAccelerator> CreateAsync(WebGPUDevice device)
        {
            var accelerator = new WebGPUAccelerator(device);
        ...
        /// </summary>
        private WebGPUAccelerator(WebGPUDevice device)
        {
